...
$PAGE_TITLE = _("pgAdmin: Development - Development team");
$PAGE_CONTENT = '
...
<ol>
  ...
  <li>People<br />&nbsp;<br />
    ...
    <ul>
      ...
      <li><a href="mailto:daniele.corsini@corsinvest.it">Daniele Corsini (frank_lupo)</a>: Has made countless improvements to the pgAdmin II code from minor bug fixes to major enhancements.</li>
