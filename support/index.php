...
<p>' . _("<b>Note: </b>For pgAdmin 4 only, bugs should be logged on the <a href=\"https://redmine.postgresql.org/projects/pgadmin4/issues/new\">tracker</a>. General questions and discussion should remain on the mailing list. Questions logged on the tracker will be closed.") . '</p>

<p>' . sprintf(_("Please <b>do not</b> send an email directly to one of the programmers; they might miss it, or even be the wrong person at all. Using the mailing list guarantees that your request isn't lost and will be answered in a timely fashion. Dave Page's <a href=\"%s\">blog</a> includes a frank posting describing why this is a bad idea, whilst Eric Raymond's paper <a href=\"%s\">'How to ask questions the smart way'</a> describes the best way to get the help you need."), "http://pgsnake.blogspot.co.uk/2005/04/support-rant-dave-goes-off-on-one.html", "http://www.catb.org/~esr/faqs/smart-questions.html") . '</p>
'; 
