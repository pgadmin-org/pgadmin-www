...
class po_status {
  ...
  function getDisplay ($_object) {
    reset ($this->_content);
    $_result = "<table class=\"pgaTranslationTable\">";
    $_result = $_result . "<tr>";
    $_result = $_result . "<th class=\"pgaTranslationTableHeader\"><a href=\"?" . $_object . "_poSortBy=locale\">" . _("Locale") ."</a></th>";
    $_result = $_result . "<th class=\"pgaTranslationTableHeader\"><a href=\"?" . $_object . "_poSortBy=language\">" . _("Language") . "</a></th>";
    $_result = $_result . "<th class=\"pgaTranslationTableHeader\"><a href=\"?" . $_object . "_poSortBy=name\">" . _("Maintainer"). "</a></th>";
    $_result = $_result . "<th class=\"pgaTranslationTableHeader\">" . _("Download") . "</th>";
    $_result = $_result . "<th class=\"pgaTranslationTableHeader\"><a href=\"?" . $_object . "_poSortBy=translated\">" . _("Translated") . "</a></th>";
    $_result = $_result . "<th class=\"pgaTranslationTableHeader\"><a href=\"?" . $_object . "_poSortBy=untranslated\">" . _("Fuzzy") . "</a></th>";
    $_result = $_result . "<th class=\"pgaTranslationTableHeader\"><a href=\"?" . $_object . "_poSortBy=status\">" . _("Status") . "</a></th></tr>";
    ...
    for ($_count = 0; $_count < $this->_size; $_count++) {
      ...
      "<td class=\"pgaTranslationTableCell\">$_locale</td>" .
      "<td class=\"pgaTranslationTableCell\">$_language</td>" .
      "<td class=\"pgaTranslationTableCell\"><a href='mailto:$_translator_email'>$_translator_name</a></td>" .
      "<td class=\"pgaTranslationTableCell\" align=\"center\"><a href='$_mo_path'>MO</a> | <a href='$_po_path'>PO</a></td>" .
      "<td class=\"pgaTranslationTableCell\" align=\"right\">". $_po_translated . "/" . $_po_total ."</td>" .
      "<td class=\"pgaTranslationTableCell\" align=\"right\">". $_po_untranslated  ."</td>" .
      "<td class=\"pgaTranslationTableCell\" align=\"right\">". $_po_status ."</td>" .
      "</tr>";
    }
